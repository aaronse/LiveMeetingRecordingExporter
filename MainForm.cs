            ...
            new XElement("PlaceWareConfCenter", new XAttribute("authUser", Properties.Settings.Default.Username), new XAttribute("authPassword", Config.Password),
                new XElement("GetURLRequest",
                    ...
                    new XElement("OptionList",
                        new XElement("StringOption", new XAttribute("name", "recViewerCompany"), new XAttribute("value", "Microsoft")),
                        new XElement("StringOption", new XAttribute("name", "recViewerName"), new XAttribute("value", "Greg")),
                        new XElement("StringOption", new XAttribute("name", "recViewerEmail"), new XAttribute("value", "gregbari@microsoft.com")),
